...
function test_examples() {
  ...
  var test_cases = [
    ...
    [
      'boolean regexMatch = Pattern.matches("str1","str2");',
      "java",
      "check if string matches regex",
    ],
    [
      '$myfile = fopen("webdictionary.txt", "r"); fclose($myfile);',
      "php",
    ...
    [
      "function_example(A) :- var(A).",
      "prolog",
      "check if variable is defined",
    ],
    [
      "function_example(A) :- nonvar(A).",
      "prolog",
      "check if variable is defined",
    ],
    [
      "function_example(A) :- integer(A).",
      "prolog",
      "check if variable is integer",
    ],
    [
      "function_example(A) :- number(A).",
      "prolog",
      "check if variable is number",
    ],
    [
      "function_example(A,B) :- number_codes(A,B).",
      "prolog",
      "convert string to integer",
    ],
    [
      "function_example(A,B,C) :- append(A,B,C).",
      "prolog",
      "concatenate string or array",
    ],
    [
      "function_example(A,B) :- findall(A,B,C).",
      "prolog",
      "list comprehension",
    ],
    ...
    [
      "public class Example{public double set_num(int a){return a;}}",
      "java",
      "class instance method",
    ],
    [
      "public class Example{public static double set_num(int a){return a;}}",
      "java",
      "class static method",
    ],
    [
      "public class Example{public Example(int a){a=a+1;}}",
      "java",
      "class constructor",
    ],
    ...
    [
      ...
      "javascript",
      "import one function from another file",
    ],
    ...
    [
      "var a1:number = 1; var a:number = ((a1>3) ? 3 : 4);",
      "typescript",
      "ternary operator",
    ],
    [
      'int parsed_int = Integer.parseInt("2");',
      "java",
      "convert string to integer",
    ],
    [
      "comprehension -> [X || X <- [1,2,3], X > 3].",
      "erlang",
      "list comprehension",
    ],
    [
      "comprehension = [x+2*x+x/2 | x <- [1,2,3,4]]",
      "haskell",
      "list comprehension",
    ],
    [
      'String reversed_string = new StringBuilder("hello").reverse().toString();',
      "java",
      "reverse string",
    ],
    ["$a = array_reverse(array(1,2,3));", "php", "reverse array"],
    [
      "$shuffled_array = shuffle(array(1,2,3,4));",
      "php",
    ...
    [
      'String[] a = "hi,stuff".split(","); String g = a.join(",");',
      "java",
      "join string",
    ],
    ...
    [
      "char char1 = Character.toUpperCase('c');",
      "java",
      "character to uppercase",
    ],
    [
      "char char1 = Character.toLowerCase('c');",
      "java",
    ...
    [
      "public static int add(int a, int b=1){return a + b;}",
      "c#",
      "optional parameter",
    ],
    [
      'Object a = "Hi"; if(a instanceof String){System.out.println(a);}',
      "java",
      "type checking",
    ],
    [
      "var numbers = [1,2,3]; var doubles = function(x) {return x * 2;};",
      "javascript",
      "anonymous function",
    ],
    [
    ...
    [
      "var numbers = [0, 1, 2, 3]; var result = numbers.reduce(function(accumulator, currentValue) {return accumulator + currentValue;});",
      "javascript",
      "array reduce",
    ],
    [
...
function understand_text(input) {
  ...
  for (var i = 0; i < output[1].length; i++) {
    ...
    if (output[1][i].length === 3 && output[1][i][1] === "means") {
      ...
      rewrite_rules = rewrite_rules.concat([
        [output[1][i][0], output[1][i][2]],
      ]);
    } else {
...
function matches_pattern_(arr, pattern, symbols) {
  if (typeof arr === typeof pattern) {
    ...
    for (var i = 0; i < arr.length; i++) {
      if (
        !(
          matches_pattern_(arr[i], pattern[i], symbols) ||
          matches_symbol(arr[i], pattern[i], symbols)
        )
      ) {
        return false;
      }
...
function matches_pattern(arr, pattern, symbols) {
  ...
  if (
    Array.isArray(arr) &&
    member(arr[0], ["==", "!=", "||", "&&", "|", "&", "logic_and", "logic_or"])
  ) {
    //if the symbol is commutative
    to_return =
      matches_pattern_([arr[0], arr[1], arr[2]], pattern, symbols) ||
      matches_pattern_([arr[0], arr[2], arr[1]], pattern, symbols);
  } else {
    //otherwise
...
function var_type(input_lang, lang, type) {
  ...
  if (member(type, type_parameters)) {
    ...
    member(type[0], ["HashMap", "dict"]) ||
    (input_lang === "smt-lib" && type[0] === "Array")
  ) {
    if (lang === "java") {
      return (
        "HashMap<" +
        var_type(input_lang, lang, type[1][0]) +
        "," +
        var_type(input_lang, lang, type[1][1]) +
        ">"
      );
    } else if (lang === "scala") {
      return (
  ...
  } else if (member(type, ["Object", "auto", "object", "any"])) {
    ...
    member(type, ["char", "varchar", "character", "rune", "Character", "u8"])
  ) {
    if (
      member(lang, [
        "java",
    ...
    if (
      ...
      member(lang, ["visual basic .net", "vba", "scala", "swift", "q#"])
    ) {
      return "Double";
    } else if (member(lang, ["go"])) {
      return "float64";
    ...
    if (member(lang, ["go"])) {
      ...
      member(lang, ["fortran", "vdm-sl", "verilog", "asymptote", "boogie"])
    ) {
      return "real";
    ...
    member(type, ["String", "string", '"string"', "str", "character(len=*)"])
  ) {
    if (
      member(lang, [
        "vala",
    ...
    if (member(lang, ["c#", "typescript"])) {
      ...
      return (
        "array[" +
        var_type(input_lang, lang, type[0]) +
        "] of var " +
        var_type(input_lang, lang, type[0])
      );
...
function var_name(lang, input_lang, var1) {
  ...
  if (
    ...
    return var1 === var1.toUpperCase() ? "$" + var1 : var1;
...
function same_var_type(a, b) {
  ...
  if (types[b] === undefined && types[a] !== undefined) {
    ...
    (Number.isInteger(parseInt(a)) && types[b] === "int") ||
    (Number.isInteger(parseInt(b)) && types[a] === "int")
  ) {
    types[a] = "int";
    types[b] = "int";
  } else if (
    !(
      member(undefined, [types[a], types[b]]) ||
      (is_numeric_type(types[a]) && is_numeric_type(types[b])) ||
      member("Object", [types[a], types[b]]) ||
      matches_pattern(types[a], types[b], {})
    )
  ) {
...
function parameter(input_lang, lang, x) {
  ...
  if (typeof x === "string") {
    ...
    if (
      member(input_lang, ["prolog", "clp(fd)", "clp(b)"]) &&
      !is_declarative_language(lang) &&
      !member(lang, ["mysql", "c", "fortran"])
    ) {
      //alert(JSON.stringify(function_params));
      return parameter(input_lang, lang, ["ref_parameter"].concat(x));
    } else if (
      member(input_lang, ["prolog", "clp(fd)", "clp(b)"]) &&
      member(lang, ["fortran", "c"])
    ) {
      //alert(JSON.stringify(function_params));
      return parameter(input_lang, lang, ["ref_parameter"].concat(x));
    }
    if (
      ...
      if (is_dynamically_typed(input_lang)) {
        ...
        param_index += 1;
        return (
          var_type(input_lang, lang, types[x[1]]) + ",intent(in) :: " + x[1]
        );
      } else {
      ...
      if (is_dynamically_typed(input_lang)) {
        ...
        param_index += 1;
        return (
          "input " + var_type(input_lang, lang, types[x[1]]) + " " + x[1] + ";"
        );
      } else {
    ...
    if (member(lang, ["cython"])) {
      ...
      member(lang, ["powershell", "transact-sql", "mysql", "pl/sql"])
    ) {
      ...
      type =
        is_dynamically_typed(input_lang) && is_statically_typed(lang)
      ...
      else return var_name(lang, input_lang, x[1]);
    } else if (
      member(lang, [
        "openoffice basic",
        "gambas",
  ...
  //optional parameters
    ...
    if (member(lang, ["c#", "c++", "vala"])) {
      ...
      member(lang, ["scala", "swift", "ada", "delphi", "typescript"])
    ) {
    ...
    if (member(lang, ["java"])) {
      ...
      member(lang, ["javascript", "coffeescript", "typescript", "php"])
    ) {
    ...
    var type = x[1];
    if (x[2].length === 1) {
      //to handle multiple parameters with one specified type
      x[2] = x[2][0];
    }
...
function function_call_parameters(input_lang, lang, name, params) {
  ...
  params = params.map(function (x) {
    return generate_code(input_lang, lang, "", x);
  });
  if (is_dynamically_typed(input_lang) && is_statically_typed(lang)) {
...
function unparse(input_lang, lang, indent, pattern_array, matching_symbols) {
  ...
  if (pattern_array.length === 1 && typeof pattern_array[0] === "string") {
    ...
    if (
      ...
      to_return =
        "(" +
        unparse(input_lang, lang, indent, pattern_array[1], matching_symbols) +
        ")";
    ...
    if (
      infix_arithmetic_lang(lang) ||
      member(lang, ["clp(fd)", "interactive data language"])
    ) {
      to_return = a + pattern_array[0] + b;
    } else if (lang === "tex") {
      if (pattern_array[0] === "*") to_return = a + " \\times " + b;
      else if (pattern_array[0] === "+") to_return = a + " + " + b;
      else if (pattern_array[0] === "-") to_return = a + " - " + b;
      ...
      member(lang, ["forth", "reverse polish notation", "joy", "factor"])
    ) {
    ...
    if (infix_arithmetic_lang(lang)) {
      to_return =
        member(lang, ["prolog"]) && pattern_array[0] === "<="
          ? a + "=<" + b
          : a + pattern_array[0] + b;
    } else if (lang === "tex") {
      to_return =
      ...
      if (pattern_array[0] === ">") {
        to_return =
          "(" +
          var_type(input_lang, lang, types[a]) +
          ".gt " +
          a +
          " " +
          b +
    ...
    var params = function_call_parameters(
      input_lang,
      lang,
      name,
      pattern_array[2].map(function (x) {
        return unparse(input_lang, lang, indent, x, matching_symbols);
      })
    );
    ...
    var list_inner = pattern_array[2].map(function (x) {
      return unparse(input_lang, lang, indent, x, matching_symbols);
    });
    ...
    if (
      member(lang, ["c", "lua", "c++", "lua", "python", "ruby", "coffeescript"])
    ) {
      to_return = "(" + a + " == " + b + ")";
    } else if (
      member(lang, ["javascript", "typescript", "php", "hack", "hs-logic"])
    ) {
      to_return = "(" + a + " === " + b + ")";
    } else if (member(lang, ["mediawiki"])) {
      to_return = "(" + a + " == " + b + ")";
    ...
    matching_symbols !== undefined &&
    pattern_array in matching_symbols
  ) {
    to_return = generate_code(
      input_lang,
      lang,
      indent,
      matching_symbols[pattern_array]
    );
  ...
  if (to_return !== "") {
    ...
    throw (
      "unparse is not defined for " +
      JSON.stringify(pattern_array) +
      " in " +
      lang
    );
  }
...
function generate_code(input_lang, lang, indent, arr) {
  ...
  if (
    arr[0] === "+" ||
    arr[0] === ".." ||
    (member(input_lang, ["haskell", "coq", "picat"]) && arr[0] === "++") ||
    arr[0] === ".." ||
    (member(input_lang, ["php", "hack", "perl"]) &&
      arr[0] === "." &&
      arr.length === 3)
  ) {
    ...
    if (
      ...
      types[a] === undefined &&
      types[b] === undefined &&
      is_dynamically_typed(input_lang)
    ) {
      types[a] = "Object";
      types[b] = "Object";
    }
    ...
    if (
      ...
      get_type(a) === "String" ||
      get_type(b) === "String" ||
      member(lang, ["javascript", "python", "ruby"])
    ) {
      //console.log("doing string concat");
      //console.log([types[a],types[b]])
      if (
        !member(get_type(a), ["String", "Object"]) &&
        member(get_type(b), ["String"])
      ) {
        a = type_conversion(input_lang, lang, get_type(a), "String", b);
      }
      if (
        !member(get_type(b), ["String", "Object"]) &&
        member(get_type(a), ["String"])
      ) {
        b = type_conversion(input_lang, lang, get_type(a), "String", b);
      }
      //console.log(JSON.stringify(types));
      //concatenate strings
      to_return = inputs_to_outputs(
        lang,
        { a1: a, b1: b },
        [
          "squirrel",
      ...
      (infix_arithmetic_lang(lang) ||
        member(lang, ["tex", "postscript", "interactive data language"])) &&
      var_type(input_lang, "java", types[a]) !== "String" &&
      var_type(input_lang, "java", types[b]) !== "String"
    ) {
      to_return = lang === "postscript" ? a + " " + b + " add" : a + "+" + b;

      same_var_type(to_return, a);
    } else {
      throw (
        "+ is not defined for " + types[a] + " and " + types[b] + " in " + lang
      );
    }
    ...
    arr === "undefined" ||
    matches_pattern(arr, [".", ["undefined"]], {}) ||
    matches_pattern(arr, [".", ["nil"]], {}) ||
    (input_lang === "visual basic .net" &&
      matches_pattern(arr, [".", ["Nothing"]], {}))
  ) {
    ...
    arr === "false" ||
    matches_pattern(arr, [".", ["false"]], {}) ||
    (lang === "common lisp" &&
      (arr === "f" || matches_pattern(arr, [".", ["f"]], {})))
  ) {
    to_return = member(lang, [
      "java",
      "zig",
    ...
    matching_patterns(
      ...
      [
        ...
        [["axiom"], [".", ["%pi"]]],
        [
          ["java", "pseudocode", "javascript", "typescript", "c#"],
          [".", ["Math", "PI"]],
        ],
        [
          ["lua", "python"],
    ...
    matches_pattern(
      arr,
      [["$a", "for", ["$b", "in", "$c"]], "where", "$d"],
      matching_symbols
    )
  ) {
    to_return = generate_code(input_lang, lang, indent, [
      "list_comprehension",
      matching_symbols["$a"],
      matching_symbols["$b"],
      matching_symbols["$c"],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["javascript"],
          [".", ["Pattern", ["function_call", "matches", ["$a", "$b"]]]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["javascript", "java", "vala", "haxe"],
          [".", ["Math", ["function_call", "exp", ["$a"]]]],
        ],
        [
          ["lua", "erlang"],
          [".", ["math", ["function_call", "exp", ["$a"]]]],
    ...
    matching_patterns(
      ...
      [
        [
          ...
          [".", ["Math", ["function_call", "cos", ["$a"]]]],
        ],
        [
          ["c#", "pseudocode", "visual basic .net"],
          [".", ["Math", ["function_call", "Cos", ["$a"]]]],
        ],
        [
          ["python", "pseudocode", "cython", "coconut", "lua", "erlang"],
          [".", ["math", ["function_call", "cos", ["$a"]]]],
        ],
        [
          ["go", "pseudocode", "wolfram", "yacas", "autohotkey"],
          ["function_call", "Cos", ["$a"]],
        ],
        [
          ["rebol", "pseudocode"],
          ["function_call", "cos/radians", ["$a"]],
        ],
    ...
    to_return =
      member(lang, ["c"]) && types[output] === "double"
        ? "cos(" + output + ")"
        : unparse(
            input_lang,
            lang,
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["wolfram", "pseudocode", "yacas", "autohotkey"],
          ["function_call", "Tan", ["$a"]],
        ],
        [
          ["rebol", "pseudocode"],
          ["function_call", "tangent/radians", ["$a"]],
        ],
        [["rust"], [".", ["$a", ["function_call", "tan", []]]]],
        [
          ["python", "pseudocode", "coconut", "cython", "lua", "erlang"],
          [".", ["math", ["function_call", "tan", ["$a"]]]],
        ],
        [
          [
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ...
          [".", ["Math", ["function_call", "floor", ["$a"]]]],
        ],
        [
          ["python", "cython", "coconut", "lua", "erlang"],
          [".", ["math", ["function_call", "floor", ["$a"]]]],
        ],
        [
          ["c#", "visual basic .net"],
        ...
        [
          ...
          ["function_call", "floor", ["$a"]],
        ],
        [
          ["go", "wolfram", "yacas", "gap", "autohotkey", "aimms"],
          ["function_call", "Floor", ["$a"]],
        ],
        [
          ["haskell", "common lisp", "julia", "yacas"],
          ["function_call", "floor", ["$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["java", "vala", "javascript", "coffeescript", "typescript", "haxe"],
          [".", ["Math", ["function_call", "ceil", ["$a"]]]],
        ],
        [
          ["python", "cython", "coconut", "lua", "scala", "nim", "erlang"],
          [".", ["math", ["function_call", "ceil", ["$a"]]]],
        ],
        [
          ["rebol"],
          [".", ["math", ["function_call", "round/ceiling", ["$a"]]]],
        ],
        [
          ["c#", "visual basic .net"],
          [".", ["Math", ["function_call", "Ceiling", ["$a"]]]],
        ],
        [
          [
            "c",
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["rebol", "pseudocode"],
          ["function_call", "arcsine/radians", ["$a"]],
        ],
        [
          ["autohotkey", "pseudocode"],
          ["function_call", "ASin", ["$a"]],
        ],
        [["rust"], [".", ["$a", ["function_call", "asin", []]]]],
        [
          ["wolfram", "pseudocode", "yacas", "aimms"],
          ["function_call", "ArcSin", ["$a"]],
        ],
        [
          ["python", "cython", "pseudocode", "coconut", "lua", "erlang"],
          [".", ["math", ["function_call", "asin", ["$a"]]]],
        ],
      ],
      matching_symbols
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["rebol", "pseudocode"],
          ["function_call", "arccosine/radians", ["$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ...
          [".", ["Math", ["function_call", "atan", ["$a"]]]],
        ],
        [
          ["c#", "english", "pseudocode", "visual basic .net"],
          [".", ["Math", ["function_call", "Atan", ["$a"]]]],
        ],
        [
          [
        ...
        [
          ["rebol", "pseudocode"],
          ["function_call", "arctangent/radians", ["$a"]],
        ],
        [["rust"], [".", ["$a", ["function_call", "atan", []]]]],
        [
          ["wolfram", "pseudocode", "yacas", "aimms"],
          ["function_call", "ArcTan", ["$a"]],
        ],
        [["vala"], [".", ["math", ["function_call", "atanh", ["$a"]]]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        [
          ...
          ["function_call", "atanh", ["$a"]],
        ],
        [
          ["erlang", "pseudocode", "python"],
          [".", ["math", ["function_call", "atanh", ["$a"]]]],
        ],
        [
          ["wolfram", "pseudocode"],
          ["function_call", "ArcTanh", ["$a"]],
        ],
        [
          ["javascript", "pseudocode", "ruby"],
          [".", ["math", ["function_call", "atanh", ["$a"]]]],
        ],
      ],
      matching_symbols
    ...
    matching_patterns(
      ...
      [
        [
          ...
          ["function_call", "acosh", ["$a"]],
        ],
        [
          ["erlang", "pseudocode", "python"],
          [".", ["math", ["function_call", "acosh", ["$a"]]]],
        ],
        [["vala"], [".", ["math", ["function_call", "acosh", ["$a"]]]]],
        [
          ["wolfram", "pseudocode"],
          ["function_call", "ArcCosh", ["$a"]],
        ],
        [
          ["javascript", "pseudocode", "ruby"],
          [".", ["math", ["function_call", "acosh", ["$a"]]]],
    ...
    matching_patterns(
      ...
      [
        [
          ...
          ["function_call", "asinh", ["$a"]],
        ],
        [
          ["erlang", "pseudocode", "python"],
          [".", ["math", ["function_call", "asinh", ["$a"]]]],
        ],
        [
          ["wolfram", "pseudocode"],
          ["function_call", "ArcSinh", ["$a"]],
        ],
        [
          ["javascript", "pseudocode", "ruby"],
          [".", ["math", ["function_call", "asinh", ["$a"]]]],
        ],
        [["vala"], [".", ["math", ["function_call", "asinh", ["$a"]]]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        [
          ["octave", "pseudocode"],
          ["function_call", "perms", ["$a"]],
        ],
        [
          ["wolfram", "pseudocode"],
          ["function_call", "Permutations", ["$a"]],
        ],
        [
    ...
    matching_patterns(
      ...
      [
        [
          ["prolog", "pseudocode"],
          ["function_call", "nonvar", ["$a"]],
        ],
        [
          ["php", "hack", "pseudocode"],
          ["function_call", "isset", ["$a"]],
        ],
        [
          ["perl", "pseudocode"],
          ["function_call", "defined", ["$a"]],
        ],
        [
          ["julia", "pseudocode"],
          ["function_call", "isdefined", ["$a"]],
        ],
        [
    ...
    matching_patterns(
      ...
      [
        ...
        [["d"], ["function_call", "mixin", ["$a"]]],
        [["wolfram"], ["function_call", "ToExpression", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["python"], ["function_call", "float", ["inf"]]],
        [["mathematical notation"], "\u221e"],
        [["c++", "c"], ["INFINITY"]],
        [["php"], ["INF"]],
        [["sage", "sympy"], ["oo"]],
        [["lua"], ["/", "1", "0"]],
        [["matlab", "octave", "julia", "r"], ["Inf"]],
        [["javascript", "wolfram"], ["Infinity"]],
        [["axiom"], ["%infinity"]],
    ...
    matching_patterns(
      ...
      [
        ...
        [["modelica"], ["function_call", "der", ["$a", "$b"]]],
        [
          ["sage", "english"],
          ["function_call", "derivative", ["$a", "$b"]],
        ],
        [["fricas"], ["function_call", "differentiate", ["$a", "$b"]]],
        [
          ["wolfram", "symja", "axiom"],
          ["function_call", "D", ["$a", "$b"]],
        ],
    ...
    if (lang === "mathematical notation") {
      var expression = generate_code(
        input_lang,
        lang,
        indent,
        matching_symbols["$a"]
      );
      var variable = generate_code(
        input_lang,
        lang,
        indent,
        matching_symbols["$b"]
    ...
    matching_patterns(
      ...
      [
        ...
        [["prolog"], ["function_call", "copy_term", ["$a", "$b"]]],
        [["core.logic"], ["function_call", "copy-term", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["wolfram"], ["function_call", "Integrate", ["$a", "$b"]]],
        [["algebrite"], ["function_call", "integral", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["erlang"], [".", ["lists", ["function_call", "sum", ["$a"]]]]],
        [["fortran"], ["function_call", "sum", ["$a"]]],
        [["interactive data language"], ["function_call", "total", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
      ...
      [
        ...
        [
          ...
          [
            "function_call",
            "Sum",
            ["$a", ["initializer_list", "Object", ["$b", "$c", "$d"]]],
          ],
        ],
        [["maxima"], ["function_call", "sum", ["$a", "$b", "$c", "$d"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["wolfram"], ["function_call", "Erfi", ["$a"]]],
        [["maple"], ["function_call", "erfi", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
  ...
  //prepend an item (a) to a list (b) (not in-place)
    ...
    matching_patterns(
      ...
      [
        [
          ["common lisp", "clojure", "racket", "emacs lisp"],
          ["function_call", "cons", ["$a", "$b"]],
        ],
  ...
  //prepend an item to an arraylist (in-place)
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["javascript", "ruby", "haxe"],
          [".", ["$a", ["function_call", "unshift", ["$b"]]]],
        ],
  ...
  //append an item to an arraylist (in-place)
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ...
          [".", ["$a", ["function_call", "push", ["$b"]]]],
        ],
        [
          ["php", "hack", "english"],
          ["function_call", "array_push", ["$a", "$b"]],
        ],
        [["perl"], ["function_call", "push", ["$a", "$b"]]],
        [
          ["wolfram"],
          ["set_var", "$a", ["function_call", "Append", ["$a", "$b"]]],
        ],
      ],
      matching_symbols
    )
    ...
    if (lang === "scala") {
      to_return =
        ...
        " +: " +
        generate_code(input_lang, lang, indent, matching_symbols["$b"]);
    } else if (lang === "mysql") {
      to_return =
        "INSERT INTO " +
        generate_code(input_lang, lang, indent, matching_symbols["$a"]) +
    ...
    matching_patterns(
      ...
      arr,
      [
        [["english"], ["&&", ["distance", "between", "$a"], "$b"]],
        [["wolfram"], ["function_call", "EuclideanDistance", ["$a", "$b"]]],
        [
          ["glsl", "english"],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["php"],
          ["access_array", ["function_call", "func_get_args", []], ["$a"]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["python", "cython", "coconut", "lua", "haskell", "erlang"],
          [".", ["math", ["function_call", "log", ["$a"]]]],
        ],
        [
          [
        ...
        [
          ["autohotkey", "go", "gap", "wolfram", "aimms"],
          ["function_call", "Log", ["$a"]],
        ],
        [
          [
    ...
    matching_patterns(
      ...
      [
        ...
        [["wolfram"], ["function_call", "Maximize", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["wolfram"], ["function_call", "Minimize", ["$a", "$b"]]],
        [["z3"], ["function_call", "minimize", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      arr,
      [
        [["minikanren"], ["function_call", "distincto", ["$a"]]],
        [["smt-lib"], ["function_call", "distinct", ["$a"]]],
        [["minizinc"], ["function_call", "alldifferent", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["java", "haxe", "javascript", "typescript", "ruby", "vala"],
          [".", ["Math", ["function_call", "log10", ["$a"]]]],
        ],
        [
          ["lua", "python", "go", "cython", "coconut", "erlang"],
          [".", ["math", ["function_call", "log10", ["$a"]]]],
        ],
        [
          ["perl"],
  ...
  // see http://rosettacode.org/wiki/Real_constants_and_functions
    ...
    matching_patterns(
      ...
      [
        [
          ["java", "javascript", "coffeescript", "typescript", "haxe"],
          [".", ["Math", ["function_call", "abs", ["$a"]]]],
        ],
        [
          ["c#", "visual basic .net", "f#", "aimms"],
          [".", ["Math", ["function_call", "Abs", ["$a"]]]],
        ],
    ...
    var to_return = generate_code(input_lang, lang, indent, [
      "parentheses",
      [
        "-",
        matching_symbols["$a"],
        [".", [["function_call", "floor", [matching_symbols["$a"]]]]],
      ],
    ]);
    types[to_return] = "double";
  } else if (
    matching_patterns(
      ...
      [
        ...
        [
          ["javascript", "typescript", "coffeescript", "java", "haxe", "scala"],
          [".", ["$a", ["function_call", "map", ["$b"]]]],
        ],
        [
          ["ocaml", "f#"],
          [".", ["List", ["function_call", "map", ["$b", "$a"]]]],
        ],
        [["erlang"], [".", ["lists", ["function_call", "map", ["$b", "$a"]]]]],
        [["c#"], [".", ["$a", ["function_call", "Select", ["$b"]]]]],
        [
          ["php", "hack"],
          ["function_call", "array_map", ["$b", "$a"]],
        ],
        [
          [
            "haskell",
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["rust", "kotlin"],
          [".", ["$a", ["function_call", "fold", ["0", "$b"]]]],
        ],
        [
          ["php", "hack"],
          ["function_call", "array_reduce", ["$b", "$a"]],
        ],
        [
          ["python", "coconut", "futhark"],
          ["function_call", "reduce", ["$b", "$a"]],
        ],
    ...
    matching_patterns(
      ...
      arr,
      [
        [["python"], [".", ["math", ["function_call", "fmod", ["$a"]]]]],
        [["vala"], [".", ["Math", ["function_call", "fmod", ["$a"]]]]],
        [
          ["c", "php"],
    ...
    matching_patterns(
      ...
      [
        ...
        [["rebol"], ["function_call", "sine/radians", ["$a"]]],
        [["bc"], ["function_call", "s", ["$a"]]],
        [
    ...
    matching_patterns(
      ...
      [
        ...
        [["futhark"], ["function_call", "flatten", ["$a"]]],
        [["javascript"], [".", ["$a", ["function_call", "flat", []]]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["maxima"], ["function_call", "realpart", ["$a"]]],
        [["ginac"], ["function_call", "real_part", ["$a"]]],
        [["sympy"], ["function_call", "re", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["sympy"], ["function_call", "imag", ["$a"]]],
        [["maxima"], ["function_call", "imagpart", ["$a"]]],
        [["ginac"], ["function_call", "imaginary_part", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      lang,
      arr,
      [[["sympy"], [".", ["$a", ["function_call", "subst", ["$b", "$c"]]]]]],
      matching_symbols
    )
  ) {
    var output = generate_code(
    ...
    matching_patterns(
      ...
      [
        ...
        [["r"], ["function_call", "Recall", "$a"]],
      ],
      matching_symbols
    )
  ) {
    var a = function_call_parameters(
      input_lang,
      lang,
      name,
      matching_symbols["$a"]
    ...
    matching_patterns(
      ...
      [
        ...
        [["php"], ["function_call", "call_user_func_array", ["$a", "$b"]]],
        [["prolog"], ["function_call", "call", ["$a", "$b"]]],
        [
          ["lua"],
          [
            "function_call",
            "$a",
            [[".", [["function_call", "unpack", ["$b"]]]]],
          ],
        ],
      ],
      matching_symbols
    ...
    matching_patterns(
      ...
      arr,
      [
        [["php"], ["function_call", "json_encode", ["$a"]]],
        [
          ["javascript"],
          [".", ["JSON", ["function_call", "stringify", ["$a"]]]],
        ],
        [["python"], [".", ["json", ["function_call", "dumps", ["$a"]]]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      arr,
      [
        [["php"], ["function_call", "json_decode", ["$a"]]],
        [["perl"], ["function_call", "decode_json", ["$a"]]],
        [["javascript"], [".", ["JSON", ["function_call", "parse", ["$a"]]]]],
        [["python"], [".", ["json", ["function_call", "loads", ["$a"]]]]],
      ],
      matching_symbols
    )
  ) {
    ...
    input_lang === "javascript" &&
    matches_pattern(arr, ["==", ["typeof", "$a"], "$b"], matching_symbols)
  ) {
    to_return = generate_code(input_lang, lang, indent, [
      "instanceof",
      matching_symbols["$a"],
    ...
    matching_patterns(
      ...
      [
        ...
        [["futhark"], ["function_call", "sgn", ["$a"]]],
        [
          ["yacas", "wolfram"],
          ["function_call", "Sign", ["$a"]],
        ],
        [["javascript"], [".", ["Math", ["function_call", "sign", ["$a"]]]]],
        [["maxima"], [".", ["Math", ["function_call", "signum", ["$a"]]]]],
        [["java"], [".", ["Math", ["function_call", "signum", ["$a"]]]]],
        [
          ["c", "c++"],
          [
            ".",
    ...
    matching_patterns(
      ...
      [
        ...
        [["wolfram"], ["function_call", "Gamma", ["$a"]]],
        [["ruby"], [".", ["Math", ["function_call", "gamma", ["$a"]]]]],
      ],
      matching_symbols
    )
  ) {
    ...
    member(lang, ["minizinc", "smt-lib"]) &&
    matches_pattern(
      arr,
      [
        "for",
        ["initialize_var", "int", "$a", "$c"],
        ["<", [".", ["$a"]], "$d"],
        ["++", "$a"],
        "$b",
      ],
    ...
    matching_patterns(
      ...
      arr,
      [
        [["prolog"], ["function_call", "append", ["$a", "$b", "$c"]]],
        [
    ...
    matching_patterns(
      ...
      lang,
      arr,
      [[["prolog"], ["function_call", "number_codes", ["$a", "$b"]]]],
      matching_symbols
    )
  ) {
    var a = generate_code(input_lang, lang, indent, matching_symbols["$a"]);
    ...
    matching_patterns(
      ...
      [
        [
          ["ruby", "python", "javascript", "minizinc"],
          [
            "parentheses",
            ["==", [".", [["access_array", "$b", ["$a"]]]], "$c"],
          ],
        ],
        [["prolog"], ["function_call", "nth0", ["$a", "$b", "$c"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["prolog"], ["function_call", "nth1", ["$a", "$b", "$c"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    var the_var = generate_code(
      input_lang,
      lang,
      indent,
      matching_symbols["$a"]
    );
    var result = generate_code(
      input_lang,
      lang,
      indent,
      matching_symbols["$b"]
    ...
    matching_patterns(
      ...
      [
        ...
        [["r"], ["function_call", "stopifnot", ["$a"]]],
        [["minizinc"], ["function_call", "constraint", ["$a"]]],
        [
          ["visual basic .net", "c#"],
    ...
    matching_patterns(
      ...
      [
		...
		*/
        ...
        [["sidef"], ["function_call", "read", ["String"]]],
        [["seed7"], ["function_call", "readln", ["string_input"]]],
        [["ocaml"], ["function_call", "read_line", []]],
        [["ruby"], [".", "gets"]],
        [["perl"], [".", "<>"]],
    ...
    matching_patterns(
      ...
      [
		...
		*/
        ...
        [["r"], ["function_call", "readline", ["$a"]]],
        [
          ["rebol", "red"],
          ["function_call", "ask", ["$a"]],
        ],
        [["erlang"], [".", ["io", ["function_call", "fread", ["$a", '"~s"']]]]],
        [["wolfram"], ["function_call", "InputString", ["$a"]]],
        [["perl 6"], ["function_call", "prompt", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        [
          ...
          [".", ["Math", ["function_call", "sqrt", ["$a"]]]],
        ],
        [
          ["erlang", "python", "coconut", "cython", "lua"],
          [".", ["math", ["function_call", "sqrt", ["$a"]]]],
        ],
        [
          ["go", "wolfram", "yacas", "aimms"],
          ["function_call", "Sqrt", ["$a"]],
        ],
        [
          ["c#", "visual basic .net"],
          [".", ["Math", ["function_call", "Sqrt", ["$a"]]]],
    ...
    matching_patterns(
      ...
      [
        [
          ["javascript", "c", "c++", "java"],
          [".", ["Math", ["function_call", "cbrt", ["$a"]]]],
        ],
        [
          ["c", "c++"],
          ["function_call", "cbrt", ["$a"]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        [
          ...
          [".", ["Math", ["function_call", "pow", ["$a", "$b"]]]],
        ],
        [
          ["erlang", "pseudocode", "lfe"],
          [".", ["math", ["function_call", "pow", ["$a", "$b"]]]],
        ],
        [
          ["rebol", "pseudocode"],
          [".", ["math", ["function_call", "power", ["$a", "$b"]]]],
        ],
        ...
        [
          ...
          ["function_call", "pow", ["$a", "$b"]],
        ],
        [
          ["hy", "pseudocode", "common lisp", "racket", "clojure", "kif"],
          ["function_call", "expt", ["$a", "$b"]],
        ],
        [
          ["clips", "egison", "pseudocode", "mathematical notation"],
          ["function_call", "**", ["$a", "$b"]],
        ],
        [
          [
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["javascript", "haxe", "coffeescript", "typescript"],
          [
            ".",
            [
              "$a",
        ...
        [
          ["php", "pseudocode"],
          ["function_call", "array_reverse", ["$a"]],
        ],
        [
          ["perl", "pseudocode", "julia", "rebol", "frink"],
          ["function_call", "reverse", ["$a"]],
        ],
        [["ruby"], [".", ["$a", "reverse"]]],
        [
          ["python", "pseudocode", "coconut"],
          ["function_call", "reversed", ["$a"]],
        ],
    ...
    member(input_lang, ["php", "hack"]) &&
    matches_pattern(arr, ["function_call", "array", "$a"], matching_symbols)
  ) {
    return generate_code(input_lang, lang, indent, [
      "initializer_list",
      "Object",
      matching_symbols["$a"],
    ]);
    ...
    matching_patterns(
      ...
      [
        [
          ...
          [".", ["$a", ["function_call", "toUpperCase", []]]],
        ],
        [
          ["rust", "pseudocode", "picat"],
          [".", ["$a", ["function_call", "to_uppercase", []]]],
        ],
        [
          ["lua", "pseudocode"],
          [".", ["string", ["function_call", "toUpperCase", ["$a"]]]],
        ],
        [
          ["go", "pseudocode"],
          [".", ["string", ["function_call", "ToLower", ["$a"]]]],
        ],
        [
          ["julia", "rebol", "pseudocode"],
          ["function_call", "uppercase", ["$a"]],
        ],
        [
          ["transact-sql", "mysql"],
          ["function_call", "upper", ["$a"]],
        ],
        [
          ["c#", "visual basic .net", "pseudocode"],
          [".", ["$a", ["function_call", "ToUpper", []]]],
        ],
        [
          ["swift", "pseudocode"],
          [".", ["$a", ["function_call", "uppercased", []]]],
        ],
        [
          ["python", "coconut", "cython", "pseudocode"],
          [".", ["$a", ["function_call", "upper", []]]],
        ],
        [
          ["php", "pseudocode"],
          ["function_call", "strtoupper", ["$a"]],
        ],
        [
          ["wolfram", "pseudocode"],
          ["function_call", "ToUpperCase", ["$a"]],
        ],
        [
          ["r", "octave", "tcl", "pseudocode"],
          ["function_call", "toupper", ["$a"]],
        ],
        [
          ["haskell", "pseudocode"],
          ["function_call", "toUpper", ["$a"]],
        ...
        [
          ["newlisp", "pseudocode"],
          ["function_call", "upper-case", ["$a"]],
        ],
        [
          ["erlang", "pseudocode"],
          ["function_call", "string:uppercase", ["$a"]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ...
          [".", ["$a", ["function_call", "toLowerCase", []]]],
        ],
        [
          ["rust", "pseudocode", "picat"],
          [".", ["$a", ["function_call", "to_lowercase", []]]],
        ],
        [
          ["c#", "pseudocode", "visual basic .net"],
          [".", ["$a", ["function_call", "ToLower", []]]],
        ],
        [
          ["swift", "pseudocode"],
          [".", ["$a", ["function_call", "lowercased", []]]],
        ],
        [
          ["python", "pseudocode", "cython", "coconut"],
          [".", ["$a", ["function_call", "lower", []]]],
        ],
        [
          ["php", "pseudocode"],
          ["function_call", "strtolower", ["$a"]],
        ],
        [
          ["julia", "pseudocode", "rebol"],
          ["function_call", "lowercase", ["$a"]],
        ],
        [
          ["perl", "pseudocode"],
          ["function_call", "lc", ["$a"]],
        ...
        [
          ["haskell", "pseudocode"],
          ["function_call", "toLower", ["$a"]],
        ],
        [
          ["octave", "pseudocode", "r", "tcl"],
          ["function_call", "tolower", ["$a"]],
        ],
        [
          ["lua", "pseudocode"],
          [".", ["string", ["function_call", "lower", ["$a"]]]],
        ],
        [
          ["go", "pseudocode"],
          [".", ["strings", ["function_call", "ToLower", ["$a"]]]],
        ],
        [
          ["wolfram", "pseudocode"],
          [".", ["strings", ["function_call", "ToLowerCase", ["$a"]]]],
        ],
        [
          ["erlang", "pseudocode"],
          ["function_call", "string:lowercase", ["$a"]],
        ],
      ],
      matching_symbols
    )
    ...
    if (
      arr === ["method_call", a, ["function_call", ["var_name", name], args]]
    ) {
      return a + args;
    }
      ...
      [
        ...
        [
          ...
          [
            ".",
            [
              [".", ["Arrays", ["function_call", "asList", ["$a"]]]],
              ["function_call", "contains", ["$b"]],
            ],
          ],
        ],
        [
          ["javascript", "typescript", "coffeescript", "pseudocode"],
          [
            "!=",
            [".", ["$a", ["function_call", "indexOf", ["$b"]]]],
            ["-", [".", ["1"]]],
          ],
        ],
        [
          ["php", "hack", "pseudocode"],
          ["function_call", "in_array", ["$b", "$a"]],
        ],
        [
          ["wolfram", "pseudocode"],
          ["function_call", "MemberQ", ["$a", "$b"]],
        ],
        ...
        [
          ["java", "swift"],
          [".", ["$a", ["function_call", "contains", ["$b"]]]],
        ],
        [["haxe"], [".", ["Lambda", ["function_call", "has", ["$a", "$b"]]]]],
        [
          ["erlang"],
          [".", ["lists", ["function_call", "member", ["$b", "$a"]]]],
        ],
      ],
      matching_symbols
    )
    ...
    if (
      matching_symbols["$a"][0] === "initializer_list" &&
      member(lang, ["smt-lib", "clips"])
    ) {
      to_return =
        "(or " +
        matching_symbols["$a"][2]
          .map(function (a) {
            return (
              "(= " +
              a2 +
              " " +
              generate_code(input_lang, lang, indent, a) +
              ")"
            );
          })
          .join(" ") +
    ...
    matching_patterns(
      ...
      [
        [
          ["erlang"],
          [".", ["sets", ["function_call", "add_element", ["$a", "$b"]]]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["erlang"],
          [".", ["sets", ["function_call", "del_element", ["$a", "$b"]]]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["erlang"],
          [".", ["sets", ["function_call", "is_element", ["$a", "$b"]]]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["erlang"],
          [".", ["sets", ["function_call", "is_subset", ["$a", "$b"]]]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["matlab", "octave"],
          ["function_call", "intersect", ["$a", "$b"]],
        ],
        [
          ["maxima", "haskell", "common lisp"],
          ["function_call", "intersection", ["$a", "$b"]],
        ],
        ...
        [
          ["erlang"],
          [".", ["sets", ["function_call", "intersection", ["$a", "$b"]]]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["matlab", "octave", "maxima", "haskell", "common lisp"],
          ["function_call", "union", ["$a", "$b"]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["erlang"],
          [".", ["sets", ["function_call", "subtract", ["$a", "$b"]]]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["go", "pseudocode"],
          [".", ["strings", ["function_call", "Index", ["$a", "$b"]]]],
        ],
        [
          ["ruby", "pseudocode"],
          [".", ["strings", ["function_call", "index", ["$a", "$b"]]]],
        ...
        [
          ["python", "coconut", "ruby", "pseudocode"],
          [".", ["$a", ["function_call", "index", ["$b"]]]],
        ],
        [
          ["perl", "pseudocode"],
          ["function_call", "index", ["$a", "$b"]],
        ],
        [
          ["php", "pseudocode"],
          ["function_call", "strpos", ["$a", "$b"]],
        ],
      ],
      matching_symbols
    )
    ...
    if (member(lang, ["mizar"])) {
      ...
      member(lang, ["asciimath", "tptp", "ileansep", "ileantap", "alloy"])
    ) {
      to_return = a + " <=> " + b;
    ...
    if (is_dynamically_typed(input_lang) && is_statically_typed(lang)) {
      ...
      member(lang, ["isabelle/hol", "mathematical notation", "lean"])
    ) {
      to_return = "\u00ac" + a;
    } else if (member(lang, ["tex"])) {
      to_return = "\\lnot " + a;
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["python", "coconut", "common lisp", "haskell"],
          ["function_call", "reversed", ["$a"]],
        ],
        [
          ["mysql", "futhark"],
  ...
  //set_dict in grammar file
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["javascript", "gosu"],
          [".", ["$a", ["function_call", "concat", ["$b"]]]],
        ],
        [["nemerle"], [".", ["$a", ["function_call", "Append", ["$b"]]]]],
        [["r"], ["function_call", "c", ["$a", "$b"]]],
        [
          ["acl2", "maxima", "newlisp", "purescript"],
          ["function_call", "append", ["$a", "$b"]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["javascript", "java"],
          [".", ["$a", ["function_call", "trim", []]]],
        ],
        [["c#"], [".", ["$a", ["function_call", "Trim", []]]]],
        [
          ["python", "coconut"],
          [".", ["$a", ["function_call", "strip", []]]],
        ],
        [["ruby"], [".", ["$a", "strip"]]],
        [["perl 6"], [".", ["$a", "trim"]]],
        [
          ["php", "mysql"],
          ["function_call", "trim", ["$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [["haxe"], [".", ["$a", ["function_call", "exists", ["$b"]]]]],
        [["php"], ["function_call", "array_key_exists", ["$b", "$a"]]],
        [["c#"], [".", ["$a", ["function_call", "containsKey", ["$b"]]]]],
        [
          ["c++", "scala"],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["python", "coconut"],
          [".", ["$a", ["function_call", "rstrip", []]]],
        ],
        [["ruby"], [".", ["$a", "rstrip"]]],
        [
          ["php", "mysql"],
          ["function_call", "rtrim", ["$a"]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["python", "coconut"],
          [".", ["$a", ["function_call", "lstrip", []]]],
        ],
        [["ruby"], [".", ["$a", "lstrip"]]],
        [
          ["php", "mysql"],
          ["function_call", "ltrim", ["$a"]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        ...
        [["scala"], [".", ["$a", ["function_call", "mkstring", ["$b"]]]]],
        [["go"], [".", ["Strings", ["function_call", "join", ["$a", "$b"]]]]],
        [["c#"], [".", ["String", ["function_call", "Join", ["$b", "$a"]]]]],
        [
          ["erlang"],
          [".", ["String", ["function_call", "join", ["$b", "$a"]]]],
        ],
        [["php"], ["function_call", "implode", ["$b", "$a"]]],
        [["coq"], ["function_call", "concat", ["$a", "$b"]]],
        [["perl"], ["function_call", "join", ["$b", "$a"]]],
        [
          ["d", "julia"],
    ...
    var a_string_list = generate_code(
      input_lang,
      lang,
      indent,
      matching_symbols["$a"]
    );
    var a_separator = generate_code(
      input_lang,
      lang,
      indent,
      matching_symbols["$b"]
    ...
    if (member(lang, ["ocaml"])) {
      to_return =
        "(String.join " + a_string_list + " ~sep:" + a_separator + ")";
    } else {
      to_return = unparse(
        input_lang,
        lang,
    ...
    matching_patterns(
      ...
      [
        ...
        [["go"], [".", ["strings", ["function_call", "split", ["$a", "$b"]]]]],
        [
          ["erlang"],
        ...
        [["haskell"], ["function_call", "splitOn", ["$a", "$b"]]],
        [["octave"], ["function_call", "strsplit", ["$a", "$b"]]],
        [["transact-sql"], ["function_call", "string_split", ["$a", "$b"]]],
        [["wolfram"], ["function_call", "StringSplit", ["$a", "$b"]]],
        [
          ["php", "hack"],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["python", "coconut"],
          [".", ["random", ["function_call", "randrange", ["$a", "$b"]]]],
        ],
        [
          ["php", "hack"],
          ["function_call", "rand", ["$a", "$b"]],
        ],
      ],
      matching_symbols
    )
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["php", "hack"],
          ["function_call", "shuffle", ["$a"]],
        ],
        [
          ["python", "coconut"],
          [".", ["random", ["function_call", "shuffle", ["$a"]]]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["java", "javascript", "coffeescript", "typescript"],
          [".", ["Math", ["function_call", "random", []]]],
        ],
        [
          ["python", "coconut"],
          [".", ["random", ["function_call", "random", []]]],
        ],
        [
          ["ruby", "c", "c++"],
          ["function_call", "rand", []],
    ...
    if (member(lang, ["python", "coconut"])) {
      ...
      to_return =
        "(" + expr + ".is_a? " + var_type(input_lang, lang, type) + ")";
    } else if (member(lang, ["kif"])) {
      to_return =
        "(instance " + expr + " " + var_type(input_lang, lang, type) + ")";
    } else if (member(lang, ["cyc"])) {
      ...
      to_return =
        "type(" + expr + ') == "' + var_type(input_lang, lang, type) + '"';
    } else if (member(lang, ["julia"])) {
      to_return = "isa(" + expr + "," + var_type(input_lang, lang, type) + ")";
    } else if (member(lang, ["javascript", "typescript", "coffeescript"])) {
      to_return =
        "typeof(" + expr + ') == "' + var_type(input_lang, lang, type) + '"';
    } else if (member(lang, ["haskell"])) {
      to_return =
        "(typeOf " + expr + ") ==" + var_type(input_lang, lang, type) + "";
      ...
      to_return =
        "(eq (type " + expr + ")F " + var_type(input_lang, lang, type) + ")";
    } else if (member(lang, ["squirrel"])) {
      to_return =
        "(" + expr + " instanceof " + var_type(input_lang, lang, type) + ")";
    } else if (member(lang, ["scala"])) {
      to_return =
        expr + ".isInstanceOf[" + var_type(input_lang, lang, type) + "]";
    ...
    var if_statement2 = generate_code(
      input_lang,
      lang,
      indent + "    ",
      arr[2]
    ...
    to_return =
      lang === "perl"
        ...
        : generate_code(input_lang, lang, indent, [
            "if",
            ["!", ["parentheses", arr[1]]],
            arr[2],
          ]);
    ...
    if (arr.length === 3) {
      if (
        ...
        member(lang, ["rust", "perl 6", "go", "tensorlang", "zephir"])
      ) {
        to_return = "if " + if_statement1 + " {" + if_statement2 + indent + "}";
      } else if (member(lang, ["mysql"])) {
        to_return =
        ...
        to_return =
          "if " + if_statement1 + "then " + if_statement2 + indent + "fi";
      } else if (member(lang, ["reverse polish notation"])) {
        to_return = if_statement1 + " " + if_statement2 + indent + " if";
      } else if (member(lang, ["yacas"])) {
        to_return =
          "If(" + if_statement1 + ",[" + if_statement2 + indent + "]);";
        ...
        to_return =
          "if " + if_statement1 + " ->" + if_statement2 + indent + "end";
        ...
        to_return =
          "(reazon-conde (" + if_statement1 + " " + if_statement2 + "))";
        ...
        to_return =
          "if(" + if_statement1 + ") then " + if_statement2 + indent + "end if";
      } else if (member(lang, ["minizinc", "aimms"])) {
        to_return =
          "if " + if_statement1 + " then " + if_statement2 + indent + "endif";
      } else if (lang === "octave") {
        ...
        to_return =
          "(if " + if_statement1 + " then " + if_statement2 + indent + ")";
      } else if (member(lang, ["ruby", "lua", "picat", "gap", "terra"])) {
        to_return =
          "if " + if_statement1 + " then " + if_statement2 + indent + "end";
        ...
        member(lang, ["applescript", "livecode", "euphoria", "turing"])
      ) {
        to_return =
          "if " + if_statement1 + " then " + if_statement2 + indent + "end if";
      } else if (member(lang, ["forth"])) {
      ...
      if (
        ...
        member(lang, ["seed7", "modelica", "parasail", "ada", "vhdl"])
      ) {
        to_return =
          "if " +
          if_statement1 +
        ...
        to_return =
          "cond do " + if_statement1 + " -> " + if_statement2 + elif_or_else;
        ...
        to_return =
          "If " + if_statement1 + if_statement2 + elif_or_else + indent + "/if";
      } else if (lang === "minizinc") {
        to_return =
          "if " +
          if_statement1 +
    ...
    to_return = inputs_to_outputs(
      lang,
      { statements1: statements1, " indent ": indent },
      [
        "hack",
        "squirrel",
        "zephir",
    ...
    if (
      ...
      to_return = first_case
        ? "if (" +
          switch_stack[switch_stack.length - 1] +
          ") == (" +
          expr +
          "): " +
          statements1
    ...
    if (member(lang, ["drools"])) {
      ...
      to_return =
        "(defrule " + name + " " + condition + " => (assert " + body + "))";
    ...
    if (
      ...
      to_return =
        "(" + a + ") ifTrue: [" + b + "]" + indent + "ifFalse: [" + c + "]";
    } else if (member(lang, ["rust", "go"])) {
      to_return = "else if " + a + " {" + b + indent + "}" + c;
    } else if (
      member(lang, ["common lisp", "emacs lisp", "kif", "minikanren"])
    ) {
      to_return = "(" + a + " " + b + ") " + c;
    } else if (member(lang, ["order"])) {
      to_return = "(" + a + "," + b + ")" + c;
  ...
  //define a subclass
    ...
    if (member(lang, ["java"])) {
      ...
      member(lang, ["rust", "haxe", "typescript", "thrift", "protobuf"])
    ) {
    ...
    to_return = member(lang, ["java", "c#"])
      ...
      : member(lang, ["visual basic .net"])
      ? access_modifier.charAt(0).toUpperCase() +
        access_modifier.slice(1) +
        " Class " +
        name +
        body +
        indent +
  ...
  //This overloading method is defined outside of a class
    ...
    //in c#, the operator overloading must be static
      ...
      to_return =
        "operator " + name + "(" + params + "){" + body + indent + "}";
    } else if (member(lang, ["haskell"])) {
      to_return = "(" + name + ") " + params + ") = " + body;
    } else if (member(lang, ["c++"])) {
      type = var_type(input_lang, lang, type);
      to_return =
        type + " operator" + name + "(" + params + "){" + body + indent + "}";
    } else if (member(lang, ["kotlin"])) {
      name === "subscript" && (name1 = "subscript");
      to_return = name1;
      type = var_type(input_lang, lang, type);
      to_return =
        name + "(" + params + ") -> " + type + " {" + body + indent + "}";
    } else if (member(lang, ["kotlin"])) {
      (name === "+" && (name1 = "plus")) ||
        (name === "-" && (name1 = "minus")) ||
        (name === "/" && (name1 = "div")) ||
        (name === "*" && (name1 = "times")) ||
        (name === "+=" && (name1 = "plusAssign")) ||
        (name === "-=" && (name1 = "minusAssign")) ||
        (name === "/=" && (name1 = "divAssign")) ||
        (name === "*=" && (name1 = "timesAssign")) ||
        (name === "%" && (name1 = "mod")) ||
        (name === "%=" && (name1 = "modAssign"));
      to_return = name1;
      type = var_type(input_lang, lang, type);
      to_return =
        "operator fun " +
      ...
      (name === "+" && (name1 = "add")) ||
        ...
        (name === "[]" &&
          //subscript operator
          (name1 = "__getitem__")) ||
        (name === "__setitem__" && (name1 = "__setitem__")) ||
        (name === "<=" && (name1 = "le"));
    ...
    var type_params;
    if (lang === "c++") {
      type_params = arr[6].map(function (x) {
        return "typename " + x;
      });
    } else {
    ...
    if (member(lang, ["zig"])) {
      ...
      type = var_type(input_lang, lang, type);
      to_return =
        "fn " + name + "(" + params + ")->" + type + "{" + body + indent + "}";
    } else if (member(lang, ["scala"])) {
      type = var_type(input_lang, lang, type);
      to_return =
        "def " +
      ...
      to_return =
        "sub " + name + "{my (" + params + ") = @_; " + body + indent + "}";
    } else if (member(lang, ["perl 6"])) {
      ...
      to_return =
        "@staticmethod" + indent + "def " + name + "(" + params + "):" + body;
      ...
      to_return =
        "def self." + name + "(" + params + ") " + body + indent + "end";
    } else if (member(lang, ["elixir"])) {
    ...
    if (member(lang, ["java", "c#", "vala"])) {
      ...
      to_return =
        "public " + name + "(" + params + ") => {" + body + indent + "}";
    } else if (member(lang, ["haskell"])) {
      if (types[name] !== "Object") {
        var names_list = arr[4]
          .map(function (x) {
            return x[1];
          })
          .join(",");
        to_return =
          ...
          "::" +
          "self -> " +
          types_list_(input_lang, lang, arr[4]).join(" -> ") +
          " -> " +
          var_type(input_lang, lang, type) +
          indent +
          name +
    ...
    if (to_return !== undefined) {
      ...
      if (types[arr[1]][0] === "HashMap") same_var_type(to_return, arr[1][2]);
      return to_return;
    }
    ...
    var params = access_array_parameters(
      input_lang,
      lang,
      name,
      indent,
    ...
    if (member(lang, ["javascript", "typescript", "haxe", "r", "php"]))
      ...
      member(lang, ["emacs lisp", "common lisp", "scheme", "clojure", "racket"])
    )
      to_return = "(lambda (" + params + ") " + body + ")";
    ...
    (member(lang, ["jison", "antlr", "lark", "gocc"]) &&
      ...
      (member(lang, ["rebol"]) && (to_return = name + ": [" + body + "]")) ||
      (member(lang, ["chrg"]) && (to_return = body + " ::> " + name + ".")) ||
      (member(lang, ["syntax definition formalism"]) &&
        (to_return = body + " -> " + name)) ||
      ...
      (member(lang, ["txl"]) &&
        (to_return =
          "define expression " + name + " " + body + " end define")) ||
      (member(lang, ["perl 6"]) &&
        (to_return = "rule " + name + "{" + body + "}")) ||
      (member(lang, [
        "peg.js",
      ...
      (member(lang, ["regex"]) &&
        (to_return = name + ' = "("+' + body + '+")";')) ||
      (member(lang, ["coco/r"]) && (to_return = name + ": " + body + ".")) ||
      (member(lang, ["prolog"]) &&
        (to_return = name + "([" + grammar_vars + "])" + "-->" + body) &&
        (grammar_vars = "")) ||
      (member(lang, ["core.logic"]) &&
        (to_return =
          "(def-->e " + name + " [" + grammar_vars + "] " + body + ")")) ||
      (member(lang, ["waxeye", "canopy", "parser-gen"]) &&
        (to_return = name + "<-" + body)) ||
      (member(lang, ["neotoma"]) && (to_return = name + "<-" + body + ";")) ||
      (member(lang, ["marpa", "cup"]) && (to_return = name + " ::= " + body)) ||
      (member(lang, ["grammar::aycock"]) &&
        (to_return = name + " ::= " + body + " {}")) ||
      (member(lang, ["java cup"]) && (to_return = name + "::=" + body + ";")) ||
      (member(lang, ["gold"]) && (to_return = "<" + name + "> ::=" + body)) ||
      (member(lang, ["nearley", "javacc", "yecc", "hime"]) &&
        (to_return = name + "->" + body)) ||
      (member(lang, ["hime"]) && (to_return = name + "->" + body + ";")) ||
    ...
    if (lang === "antlr") {
      ...
      member(lang, ["jison", "tatsu", "peg.js", "nearley", "prolog", "yecc"])
    ) {
      ...
      (member(lang, ["ometa"]) &&
        ...
        (member(lang, ["grammar:aycock"]) &&
          (to_return =
            "set " + name + " [aycock::parser {" + body + indent + "}]")) ||
        (member(lang, ["pegex"]) &&
        ...
        (member(lang, ["parslet"]) &&
          (to_return =
            "class " + name + " < Parslet::Parser" + body + indent + "end")) ||
        (member(lang, ["walrat"]) &&
          (to_return =
            "class " + name + " < Walrat::Grammar" + body + indent + "end")) ||
        (member(lang, ["citrus"]) &&
        ...
        (member(lang, ["parsimonious"]) &&
          (to_return =
            name + ' = Grammar(r"""+body+"""' + body + indent + '""")'));
    }
    ...
    (member(lang, ["prolog"]) && (to_return = a + "," + b)) ||
      (member(lang, ["fortran"]) &&
        ((input_lang === "prolog" &&
          a.indexOf("::") !== -1 &&
          (to_return = b)) ||
      ...
      (member(lang, ["sympy"]) && (to_return = a + " and " + b)) ||
      (member(lang, ["pydatalog"]) && (to_return = a + " & " + b)) ||
      (member(lang, ["javascript"]) &&
    ...
    if (lang === "c++" && input_lang === "prolog") {
      for (var i = 0; i < arr[2].length; i++) {
        params +=
          "t" + (i + 1) + " " + arr[2][i] + (i < arr[2].length - 1 ? "," : "");
      }
    ...
    if (member(lang, ["c"])) {
      ...
      to_return =
        "(define-syntax-rule " + name + " (" + params + ")" + body + ")";
    } else if (member(lang, ["racket"])) {
    ...
    if (member(lang, ["java", "c#"])) {
      ...
      (lang === "aimms" &&
        ...
        (lang === "interactive data language" &&
          ((var_type(input_lang, "java", type) === "void" &&
            (to_return =
              "PRO " + name + ", " + params + body + indent + "END")) ||
            (to_return =
              "FUNCTION " + name + ", " + params + body + indent + "END"))) ||
        (lang === "gambas" &&
          ((var_type(input_lang, "java", type) === "void" &&
            (to_return =
              "Sub " + name + "(" + params + ")" + body + indent + "End")) ||
            (to_return =
              "Function " +
              name +
              "(" +
      ...
      to_return =
        "proc " + name + "(" + params + ");" + body + indent + "end proc;";
    else if (member(lang, ["icon"]))
      to_return =
        "procedure " + name + "(" + params + ")" + body + indent + "end";
    else if (member(lang, ["order"]))
      to_return =
        "#define ORDER_PP_DEF_8" +
        name +
        " ORDER_PP_FN ( \\\n8fn(" +
        params +
        ", \\\n" +
      ...
      to_return =
        "define " + name + "(" + params + ");" + body + indent + "enddefine;";
      ...
      to_return =
        "function " + name + " " + params + body + indent + "end " + name;
    } else if (member(lang, ["kotlin"])) {
      type = var_type(input_lang, lang, type);
      to_return =
        "fun " + name + "(" + params + "):" + type + "{" + body + indent + "}";
    } else if (member(lang, ["alloy"])) {
      ...
      to_return =
        "relation " + name + "(" + params + "){" + body + indent + "}";
    else if (member(lang, ["tptp"]))
      to_return =
        "fof(" +
        name +
      ...
      member(lang, ["c++", , "dart", "ceylon", "pike", "d", "pseudocode"])
    ) {
      to_return =
        var_type(input_lang, lang, type) +
        " " +
      ...
      to_return =
        "define " + name + "(" + params + ") => {" + body + indent + "}";
    ...
    if (member(lang, ["java", "c#"])) {
      to_return =
        access_modifier +
        " " +
        var_type(input_lang, lang, types[name]) +
        " " +
        name +
        "=" +
        expr;
    ...
    matching_patterns(
      ...
      [
        [
          ["java", "javascript", "typescript", "c++", "dart", "haxe"],
          [".", ["this", "$a"]],
        ],
      ],
      matching_symbols
    ...
    if (
      ...
      to_return =
        generate_code(input_lang, lang, "", [
          "semicolon",
          ["initialize_empty_vars", arr[1][1], [arr[1][2]]],
        ]) +
        indent +
        "for(" +
        generate_code(input_lang, lang, "", ["set_var", arr[1][2], arr[1][3]]) +
        "; " +
        condition +
        "; " +
        update +
    ...
    //for languages that have while-loops but not for-loops
      ...
      to_return =
        indent +
        semicolon(lang, initial) +
        indent +
        while_loop(
          input_lang,
          lang,
          condition,
          indent + "    " + semicolon(lang, update) + body,
          indent
        );
    } else if (member(lang, ["picat"])) {
      to_return =
    ...
    if (member(lang, ["java", "c#"])) {
      ...
      if (type === "Object") {
        ...
        to_return =
          "var " + name + ":" + var_type(input_lang, lang, types[name]);
      }
    } else if (member(lang, ["php"])) {
    ...
    if (is_declarative_language(lang) || member(lang, ["rebol", "lua"])) {
      ...
      to_return =
        "final " + var_type(input_lang, lang, arr[1]) + " " + name + "=" + expr;
    } else if (member(lang, ["vhdl"])) {
      to_return =
        "constant " +
        name +
        " : " +
        var_type(input_lang, lang, arr[1]) +
        " := " +
        expr;
    } else if (member(lang, ["c++", "thrift", "glsl", "c", "d", "c#"])) {
      to_return =
        "const " + var_type(input_lang, lang, arr[1]) + " " + name + "=" + expr;
    } else if (member(lang, ["fortran"])) {
      to_return =
        var_type(input_lang, lang, arr[1]) +
        ", parameter :: " +
      ...
      to_return =
        "const " + name + ":" + var_type(input_lang, lang, arr[1]) + "=" + expr;
      ...
      if (var_type(input_lang, "java", arr[1]) === "Object") {
        ...
        to_return =
          "let " + name + ":" + var_type(input_lang, lang, arr[1]) + "=" + expr;
      }
      ...
      if (var_type(input_lang, "java", arr[1]) === "Object") {
        ...
        to_return =
          "val " + name + ":" + var_type(input_lang, lang, arr[1]) + "=" + expr;
      }
    }
    ...
    if (member(lang, ["common lisp", "racket"])) {
      the_variables = arr[1].map(function (x) {
        return generate_code(input_lang, lang, indent, x);
      });
      the_statements = generate_code(input_lang, lang, indent + "    ", arr[2]);
      to_return =
        "(let (" + the_variables.join(" ") + ") " + the_statements + ")";
    } else if (member(lang, ["minikanren"])) {
      the_variables = arr[1].map(function (x) {
        return generate_code(input_lang, lang, indent, x);
      });
      the_statements = generate_code(input_lang, lang, indent + "    ", arr[2]);
      to_return =
        "(fresh (" + the_variables.join(" ") + ") " + the_statements + ")";
    } else if (member(lang, ["core.logic"])) {
      the_variables = arr[1].map(function (x) {
        return generate_code(input_lang, lang, indent, x);
      });
      ...
      the_statements = generate_code(input_lang, lang, indent + "    ", arr[2]);
      to_return =
        the_variables.join("fresh (fn => " + indent) +
        "fresh (fn => " +
        the_statements;
      for (var i = 0; i < arr[1].length; i++) {
        to_return += ")";
    ...
    if (arr.length === 4) {
      ...
      if (member(lang, ["common lisp", "racket"])) {
        ...
        to_return = generate_code(input_lang, lang, indent, [
          "semicolon",
          ["initialize_var", arr[1], arr[2], arr[3]],
        ]);
      }
      ...
      if (member(lang, ["minikanren", "mukanren.jl"])) {
        ...
        to_return = generate_code(input_lang, lang, indent, [
          "semicolon",
          ["initialize_empty_var", arr[1], arr[2]],
        ]);
      }
    }
    ...
    if (
      ...
      to_return =
        "var " + var_type(input_lang, lang, type) + ":" + name + "=" + expr;
    } else if (member(lang, ["reverse polish notation"])) {
      to_return = name + " " + expr + " =";
    } else if (
      member(lang, [
      ...
      member(lang, ["javascript", "dart", "sidef", "gdscript", "comet"])
    ) {
      ...
      to_return =
        "var " + var_type(input_lang, lang, type) + ":" + name + " is " + expr;
    } else if (
      member(lang, ["go", "reduce", "autohotkey", "gnu smalltalk", "smalltalk"])
    ) {
      to_return = name + ":=" + expr;
    } else if (member(lang, ["ada"])) {
      if (is_dynamically_typed(input_lang) && is_statically_typed(lang)) {
      ...
      console.log(
        JSON.stringify(["types", name, types[name], expr, types[expr]])
      );
    } else if (member(lang, ["pari/gp"])) {
      to_return = "my (" + name + "=" + expr + ")";
    } else if (member(lang, ["smt-lib"])) {
      ...
      to_return =
        "var " + name + ":" + var_type(input_lang, lang, type) + "=" + expr;
    } else if (member(lang, ["vhdl"])) {
      to_return =
        "variable " +
        name +
      ...
      if (var_type(input_lang, "java", arr[1]) === "Object") {
        ...
        to_return =
          "var " + name + ":" + var_type(input_lang, lang, arr[1]) + "=" + expr;
      }
    } else if (member(lang, ["kotlin"])) {
      if (var_type(input_lang, "java", arr[1]) === "Object") {
        to_return = "val " + name + "=" + expr;
      ...
      to_return =
        name + ": " + var_type(input_lang, lang, type) + " := " + expr;
    ...
    if (member(lang, ["java", "c#"])) {
      ...
      to_return =
        "static " + var_type(input_lang, lang, types[name]) + " " + name + ";";
    } else if (member(lang, ["python", "coconut"])) {
      to_return = name + " = None";
    } else if (member(lang, ["haxe"])) {
      to_return =
        "static " + name + ":" + var_type(input_lang, lang, types[name]) + ";";
    }
    ...
    if (member(lang, ["java", "protobuf", "c#"])) {
      ...
      to_return =
        arr[1] + " var " + name + ":" + var_type(input_lang, lang, types[name]);
    } else if (member(lang, ["coq"])) {
      to_return = name + ": self -> " + var_type(input_lang, lang, types[name]);
    } else if (member(lang, ["haskell"])) {
      to_return =
        name + ":: self -> " + var_type(input_lang, lang, types[name]);
    } else if (member(lang, ["clips"])) {
      to_return = "(slot " + name + ")";
    } else if (member(lang, ["php"])) {
      ...
      to_return =
        "val mutable " + name + " : " + var_type(input_lang, lang, types[name]);
      ...
      member(lang, ["javascript", "python", "coconut", "ruby", "glsl", "rust"])
    ) {
      to_return = "";
    ...
    matching_patterns(
      ...
      [
        [
          ["java", "javascript"],
          [".", ["$a", ["function_call", "endsWith", ["$b"]]]],
        ],
        [
          ["cython", "python", "coconut"],
          [".", ["$a", ["function_call", "endsWith", ["$b"]]]],
        ],
        [["ruby"], [".", ["$a", ["function_call", "end_with?", ["$b"]]]]],
        [["swift"], [".", ["$a", ["function_call", "hasSuffix", ["$b"]]]]],
        [
          ["c#", "f#", "interactive data language"],
          [".", ["$a", ["function_call", "EndsWith", ["$b"]]]],
        ],
      ],
      matching_symbols
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["java", "cython", "python", "coconut", "ruby"],
          [".", ["$a", ["function_call", "replace", ["$b", "$c"]]]],
        ],
        [["c#"], [".", ["$a", ["function_call", "Replace", ["$b", "$c"]]]]],
        [["english"], ["function_call", "replace", ["$a", "$b", "$c"]]],
        [
          ["php", "hack"],
          ["function_call", "str_replace", ["$b", "$c", "$a"]],
        ],
        [
          ["haxe"],
          [
            ".",
            ["StringTools", ["function_call", "replace", ["$a", "$b", "$c"]]],
          ],
        ],
      ],
      matching_symbols
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["haxe"],
          [".", ["StringTools", ["function_call", "startsWith", ["$a", "$b"]]]],
        ],
        [
          ["go"],
          [".", ["strings", ["function_call", "hasPrefix", ["$a", "$b"]]]],
        ],
  ...
  /*
	...
	*/
    var list_inner = arr[1][0].map(function (x) {
      return generate_code(input_lang, lang, indent, x);
    });
    ...
    var list_inner = arr[3].map(function (x) {
      return generate_code(input_lang, lang, indent, ["key_value", x]);
    });
    if (
      member(lang, [
        "python",
      ...
      if (lang === "c#") {
        to_return =
          "new Dictionary<" +
          var_type(input_lang, lang, key_type) +
          ", " +
          var_type(input_lang, lang, value_type) +
          "> {" +
          list_inner.join(",") +
          "}";
      } else if (lang === "swift") {
    ...
    if (
      ...
      member(lang, ["php", "haxe", "perl", "ruby", "julia", "erlang"])
    ) {
      return the_key + "=>" + the_value;
    } else if (member(lang, ["futhark"])) {
      if (the_key[0] === '"') {
    ...
    var list_inner = arr[2].map(function (x) {
      return generate_code(input_lang, lang, indent, x);
    });
    if (member(lang, ["c"])) {
      to_return = "{" + list_inner.join(",") + "}";
    ...
    if (member(lang, ["python", "coconut"])) {
      to_return =
        "for " + index + "," + item + " in enumerate(" + the_list + "):" + body;
    } else if (member(lang, ["javascript"])) {
      to_return =
        "var item; for(var " +
        index +
    ...
    if (arr.length === 4) {
      if (member(lang, ["haskell", "coq", "idris", "pari/gp"])) {
        ...
        to_return =
          "(map (\\" + variable + " -> " + result + ") " + the_list + ")";
      } else if (member(lang, ["tex"])) {
        to_return =
          "\\{" + result + "\\ |\\ " + variable + " \\in " + the_list + "\\}";
        ...
        to_return =
          "(from " + variable + " in " + the_list + " select " + result + ")";
      } else if (member(lang, ["minizinc"])) {
        to_return = "[" + result + "|" + variable + " in " + the_list + "]";
      } else if (
        member(lang, ["python", "sage", "cython", "coconut", "julia"])
      ) {
        to_return = "[" + result + " for " + variable + " in " + the_list + "]";
      } else if (member(lang, ["sql", "mysql"])) {
        to_return =
          "SELECT " + result + " FROM " + variable + " IN " + the_list;
      } else if (member(lang, ["coffeescript"])) {
        to_return = "(" + result + " for " + variable + " in " + the_list + ")";
      } else if (member(lang, ["javascript", "typescript"])) {
    ...
    if (member(lang, ["java"])) {
      ...
      to_return =
        "foreach " + item + " in " + the_list + " {" + body + indent + "}";
    } else if (member(lang, ["zig"])) {
      ...
      to_return =
        "with " + item + " in " + the_list + " do {" + body + indent + "};";
    } else if (member(lang, ["f#"])) {
      to_return = "for " + item + " in " + the_list + " do" + body;
    } else if (member(lang, ["zig"])) {
      to_return =
        "for(" + the_list + ") |" + item + "| {" + body + indent + "}";
    } else if (member(lang, ["visual basic .net", "vba"])) {
      to_return =
        "For Each " +
        item +
      ...
      to_return = inputs_to_outputs(
        lang,
        { item: item, the_list: the_list, body: body, " indent ": indent },
        ["r"],
        "for(item in the_list){body indent }",
        ["dart"],
        "for(var item in the_list){body indent }",
        ["php", "hack"],
        "forall(the_list as item){body indent }",
        ["minizinc", "comet"],
        "forall(item in the_list)(body indent )",
        ["perl"],
        "foreach item(the_list){body indent }",
        ["lua"],
        "for _,item in pairs(the_list) do body indent end",
        ["javascript", "typescript"],
        "(the_list).forEach(function(item){body indent })",
        ["python", "cython", "coconut"],
        "for item in the_list:body",
        ["swift", "chapel"],
        "for item in the_list{body indent }",
        ["haxe", "groovy", "sidef", "q#"],
        "for(item in the_list){body indent }",
        ["applescript"],
        "repeat with item in the_list body indent end repeat",
        ["coffeescript"],
        "for item in the_list body",
        ["julia"],
        "for item=the_list body indent end",
        ["wolfram"],
        "Do[(body),{item,the_list}]",
        ["common lisp"],
        "(loop for item in the_list do body)",
        ["emacs lisp"],
        "(dolist (item the_list) body)",
        ["smalltalk"],
        "the_list do: [ :item | body indent ].",
        ["rebol"],
        "foreach item the_list [body indent ]",
        ["octave"],
        "foreach item = the_list body indent endfor",
        ["aimms"],
        "for (item in the_list) do body indent endfor;",
        ["tcl"],
        "foreach item the_list{body indent}",
        ["ring"],
        "for item in the_list body indent next",
        ["scala"],
        "for(item <- the_list){body indent }",
        ["ruby"],
        "the_list.each do|item|body indent end",
        ["go"],
        "for _, item := range the_list{body indent }",
        ["prolog"],
        "forall(member(item,the_list),(body indent ))",
        ["picat"],
        "foreach(item in the_list) body indent end",
        ["d"],
        "foreach(item;the_list){body indent }"
      );
    }
    ...
    if (member(lang, ["ruby"])) {
      to_return =
        "loop do" + a + indent + "    " + "break if " + b + indent + "end";
    } else {
      to_return = inputs_to_outputs(
        lang,
        { a1: a, b1: b, " indent ": indent },
        ["common lisp"],
        "(loop do a1 while b1)",
        ["scriptol"],
    ...
    return (
      indent + semicolon(lang, generate_code(input_lang, lang, indent, arr[1]))
    );
    ...
    if (
      ...
      member(input_lang, ["prolog"]) &&
      member(lang, ["lua", "javascript", "ruby"])
    ) {
      //do this when translating Prolog into languages without reference parameters
      return generate_code(input_lang, lang, indent, ["==", arr[1], arr[2]]);
    } else if (
      member(input_lang, ["fortran", "vba", "ada"]) &&
      function_name === generate_code(input_lang, lang, indent, arr[1])
    ) {
      //alert(function_name);
  ...
  //do this if it's an identifier
    ...
    member(input_lang, ["java"]) &&
    (matches_pattern(
      arr,
      [".", ["Arrays", ["function_call", "deepEquals", ["$a", "$b"]]]],
      matching_symbols
    ) ||
      matches_pattern(
        arr,
        [".", ["Arrays", ["function_call", "equals", ["$a", "$b"]]]],
        matching_symbols
      ))
  ) {
    ...
    matching_patterns(
      ...
      arr,
      [
        [["core.logic"], ["function_call", "conso", ["$a", "$b", "$c"]]],
        [
          ["prolog"],
          ["logic_equals", "$a", ["list_head_tail", "Object", "$b", "$c"]],
        ],
    ...
    if (
      ...
      to_return =
        "(" + var_type(input_lang, lang, types[a]) + ".eq " + a + " " + b + ")";
    } else if (member(lang, ["swrl"])) {
      ...
      if (member("String", [types[a], types[b]])) {
        ...
        member(types[a], ["int", "double", "float"]) ||
        member(types[b], ["int", "double", "float"])
      ) {
        to_return = a + " == " + b;
      }
    } else if (member(lang, ["forth"])) {
      ...
      member(types[a], ["int", "float", "double", "long"]) &&
      member(lang, [
        "maxima",
        "whyml",
        "alt-ergo",
    ...
    if (arr[0] === "-" && arr.length === 2) {
      ...
      if (
        types[a] === undefined ||
        (is_statically_typed(lang) && types[a] === "Object")
      ) {
        types[a] = "double";
      }
      types[to_return] = types[a];
      ...
      if (
        infix_arithmetic_lang(lang) ||
        member(lang, ["interactive data language"])
      ) {
        to_return = a + arr[0] + b;
        same_var_type(to_return, a);
      } else if (lang === "tex") {
        if (arr[0] === "*") to_return = a + " \\times " + b;
        else if (arr[0] === "+") to_return = a + " + " + b;
        else if (arr[0] === "-") to_return = a + " - " + b;
        else if (arr[0] === "/") to_return = "\\frac{" + a + "}{" + b + "}";
        same_var_type(to_return, a);
        ...
        if (arr[0] === "+") to_return = "8add(" + a + ", " + b + ")";
        else if (arr[0] === "/") to_return = "8quotient(" + a + ", " + b + ")";
        same_var_type(to_return, a);
      } else if (prefix_arithmetic_lang(lang)) {
        to_return = "(" + arr[0] + " " + a + " " + b + ")";
        same_var_type(to_return, a);
    ...
    if (
      ...
      member(lang, ["visual basic", "visual basic .net", "monkey x"])
    ) {
      to_return = a + " Mod " + b;
    } else if (member(lang, ["forth"])) {
      to_return = a + b + " mod";
    ...
    var a = generate_code(input_lang, lang, indent, arr[1]);
    var b = generate_code(input_lang, lang, indent, arr[2]);
    to_return = eager_or(a, b);
    types[to_return] = "boolean";
  } else if (arr[0] === "eager_and") {
    var a = generate_code(input_lang, lang, indent, arr[1]);
    var b = generate_code(input_lang, lang, indent, arr[2]);
    to_return = eager_and(a, b);
    types[to_return] = "boolean";
  } else if (arr[0] === "||") {
    var a = generate_code(input_lang, lang, indent, arr[1]);
    var b = generate_code(input_lang, lang, indent, arr[2]);
    ...
    if (
      ...
      member(lang, ["mathematical notation", "isabelle/hol", "swrl"])
    ) {
      to_return = a + "\u2227" + b;
    } else if (
      member(lang, [
      ...
      member(lang, ["reverse polish notation", "postscript", "forth"])
    ) {
      to_return = a + " " + b + " and";
    } else if (
      member(lang, [
    ...
    matching_patterns(
      ...
      [
        [
          ["java"],
          [".", ["System", "out", ["function_call", "print", ["$a"]]]],
        ],
        [
          ["prolog", "constraint handling rules"],
          ["function_call", "write", ["$a"]],
        ],
      ],
      matching_symbols
    )
      ...
      [
        ...
        [
          ...
          [
            ...
            [
              [".", ["System", "out"]],
              ["function_call", "print", ["$a"]],
            ],
          ],
        ],
        [["prolog"], ["function_call", "write", ["$a"]]],
        [
          ["ruby", "newlisp", "postscript"],
          ["function_call", "print", ["$a"]],
        ],
        [["c++"], ["<<", "cout", "$a"]],
      ],
      ...
      [
        ...
        [
          ...
          [
            ...
            [
              [".", ["System", "Console"]],
              ["function_call", "WriteLine", ["$a"]],
            ],
          ],
        ],
        [
          ["javascript", "typescript", "coffeescript", "pseudocode"],
          [".", ["console", ["function_call", "log", ["$a"]]]],
        ],
        [["elena"], [".", ["console", ["function_call", "writeline", ["$a"]]]]],
        [["parasail"], [".", ["IO", ["function_call", "PrintLn", ["$a"]]]]],
        [
          ["erlang", "pseudocode"],
          [".", ["io", ["function_call", "fwrite", ["$a"]]]],
        ],
        [
          ["go", "pseudocode"],
          [".", ["fmt", ["function_call", "Println", ["$a"]]]],
        ],
        [
          [
            "cython",
        ...
        [
          ["ruby", "tcl", "pseudocode", "min"],
          ["function_call", "puts", ["$a"]],
        ],
        [
          [
            "python",
        ...
        [
          ["prolog", "seed7", "pseudocode", "io", "chapel"],
          ["function_call", "writeln", ["$a"]],
        ],
        ...
        [
          ["haxe", "pseudocode"],
          ["function_call", "trace", ["$a"]],
        ],
        [
          ["octave", "pseudocode"],
          ["function_call", "disp", ["$a"]],
        ],
        [
          ["wolfram", "pseudocode"],
          ["function_call", "Print", ["$a"]],
    ...
    to_return = inputs_to_outputs(
      ...
      "include name.ew",
      ["protobuf"],
      'import "name.proto"'["futhark"],
      'import "name"'
    );
  } else if (arr[0] === "import_from" && arr.length === 3) {
    to_return = inputs_to_outputs(
      lang,
      { the_function: arr[1], the_file: arr[2] },
      ["javascript"],
    ...
    if (
      ...
      member(lang, ["lua", "r", "maxima", "wolfram", "rebol", "ocaml", "picat"])
    ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["java"],
          [".", ["Character", ["function_call", "toUpperCase", ["$a"]]]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["java"],
          [".", ["Character", ["function_call", "toLowerCase", ["$a"]]]],
        ],
        [
          ["c", "c++"],
          ["function_call", "tolower", ["$a"]],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ...
          ["function_call", "length", ["$a"]],
        ],
        [
          ["php", "hack"],
          ["function_call", "sizeof", ["$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["java", "c++", "kotlin"],
          [".", ["$a", ["function_call", "length", []]]],
        ],
        [["lua"], [".", ["string", ["function_call", "len", ["$a"]]]]],
        [
          ["python", "boa", "vdm-sl", "cython", "coconut", "fortran"],
          ["function_call", "len", ["$a"]],
        ],
        [
          ["gambas", "visual basic .net"],
          ["function_call", "Len", ["$a"]],
        ],
        ...
        [
          ["php", "zephir", "c", "pawn", "hack", "interactive data language"],
          ["function_call", "strlen", ["$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ...
          [
            ".",
            ["string", ["function_call", "sub_string", ["$a", "$b", "$c"]]],
          ],
        ],
        [
          ["haxe", "perl 6"],
          [".", ["$a", ["function_call", "substr", ["$b", "$c"]]]],
        ],
        [
          ["php", "awk", "perl", "hack"],
          ["function_call", "substr", ["$a", "$b", "$c"]],
        ],
        [
          ["haskell", "futhark"],
          [
    ...
    if (
      ...
      to_return =
        indent + arr[2] + ":" + var_type(input_lang, lang, arr[1]) + ",";
    } else if (
      member(lang, [
        "reasonml",
        "alloy",
      ...
      to_return =
        indent + "val " + arr[2] + " : " + var_type(input_lang, lang, arr[1]);
    } else if (member(lang, ["kotlin", "haxe"])) {
      to_return =
        indent + "var " + arr[2] + ":" + var_type(input_lang, lang, arr[1]);
    } else if (member(lang, ["php"])) {
    ...
    if (member(lang, ["c"])) {
      return (
        "." + arr[1] + " = " + generate_code(input_lang, lang, indent, arr[2])
      );
    ...
    if (member(lang, ["c", "c++"])) {
      ...
      member(lang, ["haskell", "coq", "f#", "ocaml", "scala", "typescript"])
    ) {
      to_return = generate_code(input_lang, lang, indent, [
        "algebraic_data_type",
        type2,
    ...
    if (member(lang, ["prolog"])) {
      ...
      return arr[2]
        .map(function (x) {
          types[x] = arr[1];
          return (
            "(local $" + x + " " + var_type(input_lang, lang, arr[1]) + ")"
          );
        })
        .join("\n");
    } else if (member(lang, ["logpy"])) {
    ...
    if (
      ...
      to_return =
        arr[2] +
        "=" +
        var_type(input_lang, "smt-lib", arr[1]) +
        "s(" +
        arr[2].split(",").join(" ") +
        ")";
    } else if (member(lang, ["minizinc"])) {
      ...
      member(lang, ["haxe", "typescript", "simit", "scala", "swift", "terra"])
    ) {
      if (var_type(input_lang, "java", arr[1]) === "Object") {
        to_return = "var " + arr[2];
      } else {
      ...
      if (var_type(input_lang, "java", arr[1]) === "Object") {
        ...
        to_return =
          "Dim " + arr[2] + " As " + var_type(input_lang, lang, arr[1]);
      }
    } else if (member(lang, ["delphi"])) {
      ...
      //for local variables
      to_return =
        "DECLARE " + arr[2] + " " + var_type(input_lang, lang, arr[1]);
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["javascript", "typescript"],
          [".", ["Math", ["function_call", "log2", ["$a"]]]],
        ],
        [["c#"], [".", ["Math", ["function_call", "Log2", ["$a"]]]]],
        [
          ["c", "matlab", "c++", "glsl", "mysql"],
          ["function_call", "log2", ["$a"]],
        ],
    ...
    (member(input_lang, ["java"]) &&
      matches_pattern(
        arr,
        [".", ["Boolean", ["function_call", "valueOf", ["$a"]]]],
        matching_symbols
      )) ||
    matches_pattern(
      arr,
      [".", ["Boolean", ["function_call", "parseBoolean", ["$a"]]]],
      matching_symbols
    )
  ) {
    to_return = type_conversion(
    ...
    matching_patterns(
      ...
      lang,
      arr,
      [[["java"], [".", ["Double", ["function_call", "parseDouble", ["$a"]]]]]],
      matching_symbols
    )
  ) {
    to_return = type_conversion(
    ...
    (member(input_lang, ["java"]) &&
      matches_pattern(
        arr,
        [".", ["Integer", ["function_call", "toString", ["$a"]]]],
        matching_symbols
      )) ||
    matches_pattern(
      arr,
      [".", ["String", ["function_call", "valueOf", ["$a"]]]],
      matching_symbols
    )
  ) {
    to_return = type_conversion(
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["maxima", "glsl", "hlsl", "echolisp"],
          ["function_call", "determinant", ["$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        [
          ["maxima", "fortran", "glsl", "hlsl", "transpose", "futhark"],
          ["function_call", "transpose", ["$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ...
          [".", ["$a", ["function_call", "filter", ["$b"]]]],
        ],
        [
          ["haskell", "python", "cython", "coconut", "futhark"],
          ["function_call", "filter", ["$b", "$a"]],
        ],
        [["oz"], ["function_call", "filter", ["$a", "$b"]]],
        [
          ["php", "hack"],
          ["function_call", "array_filter", ["$a", "$b"]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["haskell", "futhark", "erlang"],
          ["function_call", "foldr", ["$b", "0", "$a"]],
        ],
    ...
    matching_patterns(
      ...
      [
        ...
        [
          ["haskell", "futhark", "xcas"],
          ["function_call", "tail", ["$a"]],
        ],
      ],
      matching_symbols
    )
    ...
    var a = generate_code(input_lang, lang, indent, matching_symbols["$a"]);
    (member(lang, ["javascript", "coffeescript", "typescript"]) &&
      (to_return = a + "[Math.floor(Math.random() * " + a + ".length)]")) ||
      (lang === "erlang" &&
        (to_return =
          "lists:nth(random:uniform(length(" + a + "))," + a + ")")) ||
    ...
    matching_patterns(
      ...
      [
        ...
        [["maxima"], ["function_call", "laplace", ["$a", "$b", "$c"]]],
        [["sympy"], ["function_call", "laplace_transform", ["$a", "$b", "$c"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      arr,
      [
        [["sympy"], ["function_call", "fourier_transform", ["$a", "$b", "$c"]]],
        [
          ["wolfram"],
    ...
    matching_patterns(
      ...
      lang,
      arr,
      [[["wolfram"], ["function_call", "MellinTransform", ["$a", "$b", "$c"]]]],
      matching_symbols
    )
  ) {
    var a = generate_code(input_lang, lang, indent, matching_symbols["$a"]);
    ...
    matching_patterns(
      ...
      lang,
      arr,
      [[["wolfram"], ["function_call", "HankelTransform", ["$a", "$b", "$c"]]]],
      matching_symbols
    )
  ) {
    var a = generate_code(input_lang, lang, indent, matching_symbols["$a"]);
    ...
    matching_patterns(
      ...
      lang,
      arr,
      [[["wolfram"], ["function_call", "RadonTransform", ["$a", "$b", "$c"]]]],
      matching_symbols
    )
  ) {
    var a = generate_code(input_lang, lang, indent, matching_symbols["$a"]);
    ...
    matching_patterns(
      ...
      [
        ...
        [["wolfram"], ["function_call", "DSolve", ["$a", "$b", "$c"]]],
        [["maxima"], ["function_call", "desolve", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        //$a is the equation
        [["algebrite"], ["function_call", "roots", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["maple"], ["function_call", "parse", ["$a"]]],
        [["maxima"], ["function_call", "eval_string", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        //cartesian product
        [["wolfram"], ["function_call", "CartesianProduct", ["$a", "$b"]]],
        [["racket"], ["function_call", "cartesian_product", ["$a", "$b"]]],
        [
          ["python"],
          [".", ["itertools", ["function_call", "product", ["$a", "$b"]]]],
        ],
        [["ruby"], [".", ["$a", ["function_call", "product", ["$b"]]]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        //definite integral
        [["maxima"], ["function_call", "integrate", ["$a", "$b", "$c", "$d"]]],
        [["algebrite"], ["function_call", "defint", ["$a", "$b", "$c", "$d"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["maple"], ["function_call", "CrossProduct", ["$a", "$b"]]],
        [["wolfram"], ["function_call", "Cross", ["$a", "$b"]]],
        [["glsl"], ["function_call", "cross", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["maple"], ["function_call", "DotProduct", ["$a", "$b"]]],
        [
          ["glsl", "matlab"],
    ...
    matching_patterns(
      ...
      [
        ...
        [["maxima"], ["function_call", "mtimes", ["$a", "$b"]]],
        [
          ["glsl", "matlab"],
          ["function_call", "dot", ["$a", "$b"]],
        ],
        [["hlsl"], ["function_call", "mul", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        ...
        [["matlab"], ["function_call", "horzcat", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      [
        //concatenate arrays horizontally
        [["matlab"], ["function_call", "vertcat", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      arr,
      [
        [["wolfram"], ["function_call", "KroneckerProduct", ["$a", "$b"]]],
        [["matlab"], ["function_call", "kron", ["$a", "$b"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      arr,
      [
        [["wolfram"], ["function_call", "Variance", ["$a"]]],
        [["r"], ["function_call", "var", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    matching_patterns(
      ...
      arr,
      [
        [["wolfram"], ["function_call", "StandardDeviation", ["$a"]]],
        [["r"], ["function_call", "sd", ["$a"]]],
      ],
      matching_symbols
    )
  ) {
    ...
    if (member(lang, ["sql", "transact-sql", "mysql", "lua"])) {
      ...
      member(lang, ["python", "coconut", "cython"]) &&
      arr[1].length === 0
    ) {
      return indent + "pass";
    ...
    if (
      member(lang, ["minizinc", "maxima", "ocaml", "mysql", "songbird", "pure"])
    ) {
      var a = arr[1].map(function (a1) {
        return generate_code(input_lang, lang, indent, a1);
      });
  ...
  if (to_return === "") {
    ...
    if (
      !(is_dynamically_typed(input_lang) || is_dynamically_typed(lang)) &&
      types[to_return] == undefined &&
      !is_a_statement(arr[0])
    ) {
...
function is_a_statement(the_statement) {
  return (
    is_semicolon_statement(the_statement) ||
    member(the_statement, [
      "overload_operator",
      "scala_class",
      "class_implements",
      "abstract_class",
      ...
      "lexically_scoped_var",
      "protobuf_service",
      "enum",
      "initialize_constant",
      "interface_static_method",
      "generic_function",
      "generic_instance_method",
      ...
      "async_function",
      "named_parameter",
      "static_overload_operator",
      "instance_overload_operator",
      "class_extends",
      "interface_extends",
      "constructor",
      "defrule",
...
function is_semicolon_statement(the_statement) {
  return member(the_statement, [
    ...
    "generic_interface",
    "struct_statement",
    "initialize_empty_constants",
    "yield",
    "initialize_static_instance_var",
    "initialize_instance_var",
    "initialize_instance_var_with_value",
    "initialize_static_instance_var_with_value",
    "++",
    "--",
    "+=",
    "-=",
...
function parse_lang(input_lang, output_lang, input_text) {
  ...
  if (
    !(
      is_statically_typed(get_lang(output_lang)) ||
      is_dynamically_typed(get_lang(output_lang))
    )
  ) {
  ...
  if (member(input_lang, ["detect language", ""])) {
    for (var lang of Object.keys(parsers)) {
      try {
        ...
        console.log(e);
        console.log("The language isn't " + lang);
      }
    }
  } else {
...
function parse_lang_(input_lang, output_lang, input_text) {
  ...
  var generated_code = generate_code(
    input_lang,
    output_lang,
    "\n",
    parsed_text
...
function type_conversion(input_lang, lang, type1, type2, expr) {
  ...
  if (member(lang, ["transact-sql", "mysql"])) {
    to_return =
      "CONVERT(" + var_type(input_lang, lang, type2) + "," + expr + ")";
  } else if (member(lang, ["perl"])) {
    var equivalent_types = ["int", "double", "float", "String", "boolean"];
    member(type1, equivalent_types) &&
      member(type2, equivalent_types) &&
      (to_return = expr);
  } else if (member(lang, ["javascript"])) {
    (type2 === "String" &&
      type1 === "int" &&
    ...
    (type1 === "String" &&
      ...
      (type2 === "double" && (to_return = "std::stod(" + expr + ")")) ||
      (member(type1, ["double", "int"]) &&
        type2 === "String" &&
        (to_return = "std::to_string(" + expr + ")"));
  } else if (member(lang, ["java"])) {
    (type1 === "String" &&
      ((type2 === "int" && (to_return = "Integer.parseInt(" + expr + ")")) ||
        (type2 === "double" &&
...
function while_loop(input_lang, lang, arr1, arr2, indent) {
  ...
  return inputs_to_outputs(
    lang,
    { arr1: arr1, arr2: arr2, " indent ": indent },
    [
      "c",
      "glsl",
      "typescript",
...
function array_contains(lang, a1, a2) {
  ...
  if (member(lang, ["c++"])) {
    ...
    return inputs_to_outputs(
      ...
      ["perl"],
      "(a1 ~~ a2)",
      ["python", "coconut", "julia", "minizinc", "mysql"],
      "(a2 in a1)",
      ["coq"],
      "(In a1 a2)",
      ["haskell"],
      ...
      "a1[a2] !== nil",
      ["c#"],
      "(Array.indexOf(a1,a2) > -1)",
      ["rebol"],
      "not none? find a1 a2",
      ["reasoned-php", "logpy", "core.logic"],
      "membero(a2,a1)",
      ["hs-logic"],
      "(membero a2 a1)",
      ["erlang"],
...
function matching_patterns(
  ...
  for (let pattern of patterns) {
    if (
      member(input_lang, pattern[0]) &&
      matches_pattern(arr, pattern[1], matching_symbols)
    ) {
...
function initializer_list(input_lang, lang, list_inner) {
  ...
  if (
    ...
    to_return =
      "\\begin{bmatrix} " + list_inner.join(" & ") + " \\end{bmatrix}";
  } else if (
    member(lang, ["reazon", "clojure", "racket", "emacs lisp", "minikanren"])
  ) {
    to_return = "'(" + list_inner.join(" ") + ")";
    ...
    to_return =
      "[]" +
      var_type(input_lang, lang, types[list_inner[0]]) +
      "{" +
      list_inner.join(",") +
      "}";
  } else if (member(lang, ["java"])) {
